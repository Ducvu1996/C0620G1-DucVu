...
public class MineSweeper {
	...
	public static void main(String[] args) {
		...
		for (int yOrdinate = 0; yOrdinate < MAP_HEIGHT; yOrdinate++) {
		    ...
		    for (int yOrdinates = 0; yOrdinates < MAP_HEIGHT; yOrdinates++) {
		        for (int xOrdinates = 0; xOrdinates < MAP_WIDTH; xOrdinates++) {
		            String currentCellReport = mapReport[yOrdinates][xOrdinates];
